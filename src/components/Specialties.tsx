            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <h3 className="font-heading text-xl font-semibold text-brand-light">
                      {dish.name}
                    </h3>
                  ...
                  <span className="font-heading text-xl font-bold text-brand-accent group-hover:text-brand-gold transition-colors duration-300">
                    {dish.price}
                  </span>
                </div>
