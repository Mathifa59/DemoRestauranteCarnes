      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          >
            ...
            <h2 className="mt-4 font-heading text-3xl font-bold leading-tight text-brand-light sm:text-4xl lg:text-5xl">
              Nacidos del{" "}
            ...
            {/* Stats */}
            <div className="mt-10 grid grid-cols-3 gap-4 sm:gap-6 border-t border-brand-gold/10 pt-10">
              {[
                { value: "15+", label: "Años" },
                ...
                <div key={stat.label}>
                  <span className="font-heading text-2xl font-bold text-brand-accent sm:text-3xl lg:text-4xl">
                    {stat.value}
                  </span>
                  <p className="mt-1 text-[10px] sm:text-xs tracking-widest uppercase text-brand-light/40">
                    {stat.label}
                  </p>
                </div>
              ))}
          ...
          >
            <motion.div style={{ y: imageY }} className="relative">
              ...
              {/* Decorative frame */}
              <div className="absolute -top-4 -right-4 h-full w-full border border-brand-gold/15 -z-10 hidden sm:block" />

              {/* Quote overlay */}
              <div className="absolute bottom-8 left-8 right-8 border-l-2 border-brand-gold/40 pl-6">
                <p className="font-heading text-lg italic text-brand-light/80">
        ...
        >
          ...
          <div className="relative lg:col-span-2">
            <div className="relative aspect-4/5 overflow-hidden">
              ...
              />
              <div className="absolute inset-0 bg-linear-to-r from-brand-dark/30 to-brand-dark/60" />
            </div>
          </div>

          {/* Large editorial text */}
          <div className="lg:col-span-3">
            <h3 className="font-heading text-3xl font-bold leading-tight text-brand-light sm:text-4xl md:text-5xl lg:text-6xl">
              Cada corte
              <br />
              tiene una{" "}
